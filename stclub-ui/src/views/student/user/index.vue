  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="学院" prop="college">
        <el-select v-model="queryParams.college">
          <el-option
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['student:user:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['student:user:export']"
        >导出</el-button>
      </el-col>
...
<!--      <el-table-column label="学院id" align="center" prop="college" />-->
...
<!--      <el-table-column label="用户密码" align="center" prop="password" />-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="学院id" prop="college">
          <el-input v-model="form.college" placeholder="请输入学院id" />
        </el-form-item>
        <el-form-item label="用户名" prop="userName">
...
<script>
import { listUser, getUser, delUser, addUser, updateUser, changeUserStatus } from "@/api/student/user";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('student/user/export', {
        ...this.queryParams
