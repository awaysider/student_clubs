...
import com.stclub.framework.config.ServerConfig;
...
public class CommonController
{
    ...
    @Autowired
    private MinioClientUtils minioUtil;
...
//        }
//        try {
//            if (!minioUtil.bucketExists("studentClub")) {
//                minioUtil.makeBucket("studentClub");
//            }
//
//            String fileName = file.getOriginalFilename();
//            String newName = "image/" + UUID.randomUUID().toString().replaceAll("-", "")
...
//
//            InputStream inputStream = file.getInputStream();
//            minioUtil.putObject("studentClub", file, newName);
//            inputStream.close();
//
//            String url = minioUtil.getObjectUrl("studentClub", newName);
//            return url;
//        } catch (Exception e) {
//            e.printStackTrace();
//            return "上传失败";
